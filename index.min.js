...
`.slice(1),
  ...
  async function execute() {
    ...
    const convert = new import_ansi_to_html.default({
      newline: true,
      colors: {
        9: "#be0000",
        10: "#1b951e",
    ...
    worker.addEventListener("message", (event) => {
      if (event.data[0] === "log") {
        codeOutput.innerHTML = codeOutput.innerHTML + convert.toHtml(event.data[1].map(stringify).join(" ") + "\n");
        return;
      }
  ...
  execute();
  var executeDebounce = (0, import_debounce.default)(execute, 500);
