(() => {
    ...
    "node_modules/ansi-to-html/lib/ansi_to_html.js"(exports, module) {
      ...
      var Filter = /* @__PURE__ */ function() {
        function Filter2(options) {
          ...
          options = options || {};
          if (options.colors) {
            options.colors = Object.assign({}, defaults3.colors, options.colors);
          }
  ...
  function createTestSuite(options = {}) {
    ...
    const test = (name2, fn) => {
      context.tests.push({ name: name2, fn });
    };
    test.skip = (name2, fn) => {
      context.skipped.push({ name: name2, fn });
    };
    test.only = (name2, fn) => {
      context.only.push({ name: name2, fn });
    };
    return {
      test,
  ...
  // index.js
  window.realCreateTestSuite = createTestSuite;
  window.AnsiToHTML = import_ansi_to_html.default;
...
`.slice(1),
  ...
  execute();
  var executeDebounce = (0, import_debounce.default)(execute, 150);
