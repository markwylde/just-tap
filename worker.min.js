(() => {
  ...
  var getStack = (error) => {
    try {
      ...
      const line = lines.find((line2) => line2.includes("(eval at "));
  ...
  var runTest = async (context, test) => {
    ...
    const diffObjects = (a, b) => {
      ...
      let debug = "";
      diff2.forEach((part, index, array) => {
    ...
    const cleanup = await test.fn({
      ...
      throws: (fn, expected, message) => {
        ...
        const ok = (0, import_deep_equal.default)(error, expected, { strict: true });
      ...
      deepEqual: (a, b, message) => {
        const ok = (0, import_deep_equal.default)(a, b, { strict: true });
  ...
  var run = async (context, { concurrency } = { concurrency: Infinity }) => {
    ...
    for (const test of context.tests) {
      ...
      await waitUntil_default(() => context.running < concurrency);
    }
